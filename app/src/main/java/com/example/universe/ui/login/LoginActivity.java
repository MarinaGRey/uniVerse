...
public class LoginActivity extends AppCompatActivity {
                                ...
                                FirebaseMessaging.getInstance().getToken()
                                        .addOnCompleteListener(task1 -> {
                                            if (task1.isSuccessful()) {
                                                String deviceToken = task1.getResult();
                                                ...
                                                db.collection("users")
                                                        ...
                                                        .addOnFailureListener(e -> Toast.makeText(LoginActivity.this, "Failed to store user details.", Toast.LENGTH_SHORT).show());
                                            } else {
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        db.collection("users").document(userId)
                                ...
                                .addOnFailureListener(e -> Toast.makeText(LoginActivity.this, "Failed to update device token.", Toast.LENGTH_SHORT).show());
                    } else {
                        Toast.makeText(LoginActivity.this, "Failed to retrieve device token.", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private final ActivityResultLauncher<String> requestPermissionLauncher =
            registerForActivityResult(new ActivityResultContracts.RequestPermission(), isGranted -> {
                if (!isGranted) {
                    Toast.makeText(LoginActivity.this, "You will not receive notifications", Toast.LENGTH_SHORT).show();
                }
            });
}
