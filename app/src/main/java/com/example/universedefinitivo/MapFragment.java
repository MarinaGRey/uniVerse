...
public class MapFragment extends Fragment {
    ...
    private FrameLayout mapModalLayout;
    private Button mapPostButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addLocationButton = rootView.findViewById(R.id.add_location_button);
        closeModal = rootView.findViewById(R.id.close_button);
        mapModalLayout = rootView.findViewById(R.id.modal_layout);
        mapPostButton = rootView.findViewById(R.id.map_post_button);
